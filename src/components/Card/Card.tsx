      ...
      <CardContainer>
        {modalOpen && (
          <Modal
            ...
            item={item}
            image={`https://api.doggydoggykittykitty.site/api/image/${item.Photo.url}`}
          />
        )}
        <HeaderContainer>
          <UserContainer>
            <UserWrap>
              <UserImageContainer onClick={navigateUserPage}>
                <UserImage
                  src={
                    isProfileImage
                      ? `https://api.doggydoggykittykitty.site/api/image/${item.User.Profile.url}`
                      : noProfileImage
                  }
                />
              </UserImageContainer>
...
const CardImage = styled.div<{ image: string }>`
  width: 100%;
  padding-bottom: 100%;
  background-image: url(https://api.doggydoggykittykitty.site/api/image/${props => props.image});
